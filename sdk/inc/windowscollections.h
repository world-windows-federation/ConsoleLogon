...
namespace XWinRT
{
    ...
    struct InterfaceLifetimeTraits
    {
        ...
        template <class TInterface>
        static HRESULT Construct(XWinRT::detail::GitStorageType<TInterface>* uninitializedElement, XWinRT::detail::GitStorageType<TInterface>& source)
        {
            static_assert(XWinRT::FakeStl::is_base_of<IUnknown, TInterface>::value,
                          "DefaultLifetimeTraits only supports interface derived from IUnknown");
...
namespace Windows { namespace Foundation { namespace Collections { namespace Internal {
    ...
    {
        using RuntimeClassT = RuntimeClass<wfc::IMapChangedEventArgs<K>>; // @MOD Fix compile error
    ...
    class HashMap : public
        ...
        >::type
    {
        using RuntimeClassT = typename detail::_if <HashMapOptions::hasObservable,
            Microsoft::WRL::RuntimeClass<wfc::IMap<K, V>, wfc::IIterable<wfc::IKeyValuePair<K, V>*>, wfc::IObservableMap<K,V>>,
            Microsoft::WRL::RuntimeClass<wfc::IMap<K, V>, wfc::IIterable<wfc::IKeyValuePair<K, V>*>>
        >::type; // @MOD Fix compile error
    ...
    {
        using RuntimeClassT = Microsoft::WRL::RuntimeClass< wfc::IMapView<K, V>, wfc::IIterable<wfc::IKeyValuePair<K, V>*> >; // @MOD Fix compile error
    ...
    {
        using RuntimeClassT = Microsoft::WRL::RuntimeClass<wfc::IKeyValuePair<K,V>>; // @MOD Fix compile error
    ...
    private:
        ...
        class ChunkElementIterator WrlSealed : public
            Microsoft::WRL::RuntimeClass< wfc::IIterator<wfc::IKeyValuePair<K, V>*> >
        {
            using RuntimeClassT = Microsoft::WRL::RuntimeClass< wfc::IIterator<wfc::IKeyValuePair<K, V>*> >; // @MOD Fix compile error
